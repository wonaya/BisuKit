...
RUN cd /home/bisukit/; curl https://cran.r-project.org/src/base/R-2/R-2.15.1.tar.gz | tar xz;\
  cd R-2.15.1; chmod +x configure; ./configure --enable-R-shlib ; make ; make install 
RUN cd /home/bisukit/; curl https://pypi.python.org/packages/bc/90/c8d2af086dfeaa9aabdeb4da9e196ac06a3187b1943e20fc9cd17cb3d885/rpy2-2.2.1.tar.gz | tar xz ;\
  cd rpy2-2.2.1;  python setup.py build ; python setup.py install 
...
#COPY R /home/bisukit/.
#RUN tar -zxvf /home/bisukit/lib.tar.gz
...
CMD cd /home/bisukit && /usr/bin/python2.7 bisukit.py --name1 sample1 --name2 sample2 --ot1 CpG_OT_sample1.txt --ot2 CpG_OT_sample2.txt --ob1 CpG_OB_sample1.txt --ob2 CpG_OB_sample2.txt --context CpG --genome TAIR_4.fa --specie TAIR --cores 4
